...
EXPECTED_RESULTS: dict[int, list[tuple[int, tuple[int | str, int | str]]]] = {
    2025: [
        ...
        (3, (17100, 170418192256861)),
        (4, (1416, 9086)),
        (5, (652, 341753674214273)),
        (6, (6100348226985, 12377473011151)),
        (7, (1539, 6479180385864)),
        (8, (63920, 1026594680)),
        (9, (4774877510, 1560475800)),
        (11, (652, 362956369749210)),
        (12, (451, -1)),
    ],
    2024: [
        (1, (1873376, 18997088)),
        ...
        (24, (55920211035878, "btb,cmv,mwp,rdg,rmj,z17,z23,z30")),
        (25, (3439, -1)),
    ],
    2023: [
        (1, (54951, 55218)),
    ...
    2018: [
        (1, (522, 73364)),
        (2, (7776, "wlkigsqyfecjqqmnxaktdrhbz")),
        (3, (105231, 164)),
        (4, (125444, 18325)),
        (5, (11946, 4240)),
        (6, (3260, 42535)),
        (7, ("HPDTNXYLOCGEQSIMABZKRUWVFJ", 908)),
        (8, (37905, 33891)),
        (9, (398242, 3273842452)),
        (10, ("ERKECKJJ", 10645)),
        (11, ("34,13", "280,218,11")),
